  ...
  <div class="wrap">
    ...
    <div class="hero-grid">
      ...
      <div class="hero-sub">
        ...
        <div class="byline">
          A cura di <a href="https://github.com/federicokalik">Federico Calicchia</a> · redatto con il supporto di GLM 5.3 Flash (Z.ai) su indicazioni editoriali, a partire da una ricerca condotta con Claude Opus 5 (Anthropic).
        </div>
        <div class="meta-row"><span>Ultimo aggiornamento · 11 settembre 2026</span></div>
      </div>
    </div>
  </div>
</header>
...
<section id="tldr">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      <h2>Cinque punti</h2>
      <ul class="keylist">
        <li><div>Lo zero-click è strutturale: nel 2024 il 58,5% delle ricerche Google USA finiva senza click (SparkToro/Datos), salito al <strong>68,01%</strong> nei primi quattro mesi del 2026. Con un AI Overview il CTR organico della pagina top cala del <strong>47-61%</strong> a seconda dello studio (Authoritas, Pew, Seer Interactive, Ahrefs) — ma il declino si è fermato: il CTR con AIO è risalito da ~1,3% (dic 2025) a ~2,4% (feb 2026), con un divario strutturale residuo del ~37% (Seer, 53 brand, 5,47M query).</div></li>
      ...
      <div class="note">
        <strong>Aggiornamento settembre 2026 (giu → set).</strong> Le novità sostanziali dopo la chiusura della prima versione (22 giugno 2026): (1) <strong>Search Console — report "Generative AI"</strong> (UK dal 3 giugno 2026, globali dal 31 agosto: solo impression, niente click né prompt; opt-out senza penalità). (2) <strong>Cloudflare</strong> blocca di default i crawler AI "mixed-use" su pagine con pubblicità dal <strong>15 settembre 2026</strong>; Pay Per Crawl → Pay Per Use. (3) <strong>AI Act UE</strong> — obblighi di trasparenza (art. 50) in vigore dal <strong>2 agosto 2026</strong> (linee guida 20 luglio; transitorio fino al 2 dicembre; sanzioni fino a €15M o 3%). (4) <strong>AI Mode in Francia</strong> dal 22 luglio 2026, con impegni su opt-out editori. (5) <strong>ChatGPT Atlas dismesso come browser</strong> il 9 agosto; Perplexity Comet gratuito e su Android dal 19 agosto. (6) <strong>Dati di svolta:</strong> CTR con AIO in rimbalzo (Seer) e traffico da AI che converte molto meglio (Semrush 4,4x; Ahrefs 23x; Adobe +42%). (7) <strong>Mercato:</strong> ChatGPT sotto il 50% della quota app (mar 2026; Gemini ~28%, Claude ~10%); run rate Anthropic $47B. (8) <strong>Licensing:</strong> RSL Media / Human Consent Standard; crawler AI = 52% del traffico bot.
      </div>
      <div class="panel">
        <h4>Key Findings</h4>
        <ol>
          <li><strong>Il comportamento di ricerca è cambiato strutturalmente, non marginalmente.</strong> Lo zero-click è passato da ~50% (SparkToro 2019) a 68,01% (gen–apr 2026 USA). Gartner ha previsto (feb 2024) un calo del 25% del volume di ricerca tradizionale entro il 2026 — una previsione, non un consuntivo: a metà 2026 non si è verificata nella misura prevista.</li>
          <li><strong>Il posizionamento organico tradizionale resta importante ma non è più sufficiente.</strong> Ahrefs (gen 2026): solo il 38% delle pagine citate negli AI Overviews è anche nella top-10 organica (era 76% a luglio 2025); l'overlap è poi sceso a un range 12–54% a inizio 2026 secondo i diversi studi.</li>
  ...
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ul>
        ...
        <li>7 mag 2026: Chrome rilascia Lighthouse 13.3.0 con la categoria sperimentale "Agentic Browsing", incluso un check opzionale su <code>llms.txt</code>.</li>
        ...
        <li>3 giu 2026: Search Console lancia i report "Search Generative AI" (impression in AI Overviews, AI Mode e Discover) per un sottoinsieme di siti UK, su mandato CMA/DMA.</li>
        <li>20 lug 2026: la Commissione UE pubblica le linee guida volontarie per il Code of Practice sull'etichettatura AI (art. 50 AI Act), applicabile dal 2 agosto 2026.</li>
        <li>22 lug 2026: AI Mode e AI Overviews arrivano in Francia, ultimo grande mercato UE, con impegni su opt-out editori e diritti connessi.</li>
        <li>31 ago 2026: i report "Generative AI" di Search Console diventano globali (dati dal 18 maggio 2026, nessun backfill; solo impression; opt-out senza penalità).</li>
        <li>15 set 2026 (annunciato il 1° luglio): Cloudflare attiva il blocco di default dei crawler AI "mixed-use" su pagine con pubblicità (nuovi clienti, nuovi siti, clienti free); Pay Per Crawl → Pay Per Use.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Seer Interactive (studio longitudinale, dati a feb 2026; 53 brand, 5,47M query):</strong> dato di svolta — il CTR organico in presenza di AIO è sceso a un minimo di ~1,3% a dicembre 2025 per poi <strong>risalire a ~2,4% a febbraio 2026</strong> (recupero ~85%, inversione di un declino di 18 mesi). Resta un divario strutturale di ~37% rispetto alle query senza AIO (2,4% vs 3,8%).</li>
        <li><strong>Qualità del traffico da AI (mar 2026):</strong> Semrush — il visitatore medio da AI search vale <strong>4,4x</strong> quello dell'organico tradizionale; Ahrefs — AI search = 0,5% del traffico ma 12,1% degli signup (<strong>23x</strong>); Adobe Digital Insights — traffico da AI convertiva <strong>+42%</strong> rispetto al non-AI a marzo 2026 (inversione dal −43% di luglio 2024). <em>(Attenzione: definizioni di "conversione" diverse e campioni spesso auto-selezionati.)</em></li>
        <li><strong>Gartner (feb 2024):</strong> previsione −25% del volume di ricerca tradizionale entro il 2026 (previsione, non consuntivo). A settembre 2026 non si è verificata nella misura prevista.</li>
...
<section id="s2">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ul>
        <li><strong>ChatGPT (OpenAI):</strong> retrieval via API di scraping di terze parti (storicamente legato a Bing; Seer ha trovato 87% di overlap con i top result di Bing); query fan-out; selezione fonti che pesa autorevolezza, struttura e freschezza. Il browser <strong>ChatGPT Atlas è stato dismesso il 9 agosto 2026</strong>: le funzioni agentiche vivono nell'app ChatGPT e in un'estensione Chrome.</li>
        <li><strong>Google Gemini / AI Overviews / AI Mode:</strong> indice web proprio + Knowledge Graph + Shopping; query fan-out documentato via API; selezione che attinge anche fuori dalla top-10 (Ahrefs gen 2026: solo 38% delle citazioni dalla top-10). Scala ufficiale: <strong>2,5 miliardi di utenti mensili</strong> per gli AI Overviews e <strong>1 miliardo per AI Mode</strong> (Google I/O, maggio 2026; query che raddoppiano ogni trimestre da launch, Liz Reid). AI Mode gira su Gemini 2.5/3.5 Flash.</li>
        <li><strong>Perplexity:</strong> RAG con crawler proprio (PerplexityBot); forte sensibilità alla freschezza; tipicamente 3-5 fonti per risposta; reranking ML a più livelli. Il browser agentic <strong>Comet</strong> è ora gratuito e cross-platform (Mac, Windows, iOS, Android — su Android dal 19 agosto 2026).</li>
      ...
      <p>Scala: a metà 2025 i modelli alimentavano ~1,5 miliardi di utenti mensili negli AI Overviews e ~400M nell'app Gemini; a fine 2025/inizio 2026 i numeri ufficiali Alphabet salgono a <strong>2 miliardi</strong> di utenti per gli AI Overviews e <strong>750 milioni</strong> di MAU per l'app Gemini (Q4 2025); a Google I/O (maggio 2026) Google dichiara <strong>2,5 miliardi</strong> di utenti mensili per gli AI Overviews e <strong>1 miliardo per AI Mode</strong>, con query che raddoppiano ogni trimestre (Liz Reid). AI Mode usa una <em>"custom version of Gemini"</em> con fan-out, che scompone la query in molte sotto-query parallele — il motivo per cui pagine non in top-10 vengono citate. <strong>Conseguenza GEO:</strong> ottimizzare per Gemini significa coprire l'<strong>albero di sotto-domande</strong> di un tema, non una singola keyword.</p>
      ...
      <div class="tablewrap"><table>
        ...
        <tr><td>Trasparenza</td><td>Bassa (rev-eng)</td><td>Media-alta (API + report Search Console, solo impression)</td><td>Bassa-media</td><td>Alta (doc + report)</td><td>Media (doc)</td></tr>
      </table></div>
    </div>
  </div>
</section>
  ...
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ul>
        ...
        <li><strong>Menzioni del brand:</strong> il volume di ricerca del brand è il predittore più forte delle citazioni AI (correlazione 0,334 secondo Previsible/5WPR; menzioni non linkate 0,664), più dei backlink; la presenza su Wikidata/Wikipedia + piattaforme autorevoli può moltiplicare la probabilità di citazione ~2,8x.</li>
      </ul>
      ...
      <p><strong>Correlazione col ranking tradizionale (dati contrastanti):</strong> Ahrefs a luglio 2025 trovava 76% di overlap tra citazioni AIO e top-10, a gennaio 2026 solo 38% (in parte per migliore rilevamento, in parte per il fan-out); a inizio 2026 l'overlap è sceso a un range 12–54% secondo i diversi studi (solo il 12% degli URL citati dagli LLM è in top 10 secondo Ahrefs). Semrush: ~90% delle citazioni ChatGPT da URL fuori dalla top-20 Google. Il ranking aiuta ma non è condizione necessaria.</p>
...
<section id="s4">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <h4>Adozione</h4>
      <p><strong>Eurostat 2025:</strong> uso di strumenti GenAI in Italia al <strong>20%</strong> (19,9% per la rilevazione ufficiale), sotto la media UE del 32,7% e lontano da Norvegia (56%) e Danimarca (48%); riflette il divario nord-sud europeo. ChatGPT in Europa: utenti attivi mensili medi da 11,2 a 41,3 milioni entro marzo 2025 (~+270%). L'Italia è stata il <strong>primo paese al mondo</strong> a bloccare temporaneamente ChatGPT (marzo 2023). <strong>Adozione misurata come audience (da non fondere con Eurostat):</strong> ~15 milioni di italiani (35% della popolazione online 18-74) usavano app AI a dicembre 2025, più del doppio del 2024 (Audicom-Audiweb); ChatGPT 10,1 milioni di utenti unici (23,6% della popolazione 18-74); ChatGPT genera oltre l'84% del traffico di referral AI in Italia (We Are Social/Meltwater, <em>Digital 2026: Italy</em>). La divergenza Eurostat (~20%) vs Audiweb (~35%) riflette definizioni diverse: vanno presentate entrambe con fonte, non fuse.</p>
      <h4>Tempistica AI Overviews in Europa</h4>
      <p>Arrivati in Italia il <strong>26 marzo 2025</strong> (con Austria, Belgio, Germania, Irlanda, Polonia, Portogallo, Spagna, Svizzera), ~10 mesi dopo gli USA, in italiano e su Gemini 2.0. Si attivano per query informative a coda lunga. L'AI Mode in italiano non risultava pienamente lanciato a metà 2026. <strong>Il precedente francese (luglio 2026):</strong> la Francia è stata inizialmente <strong>esclusa</strong> dal rollout di AI Mode e AI Overviews per ragioni regolatorie sui diritti connessi; dal <strong>22 luglio 2026</strong> entrambe le feature sono attive anche lì, con impegni di Google su opt-out editori e compensazione — il caso di riferimento per il dibattito FIEG-AGCOM/UE.</p>
      ...
      <h4>Quote di mercato occidentali aggiornate (settembre 2026)</h4>
      <p>Dato recente più rilevante: <strong>ChatGPT è sceso sotto il 50% della quota app a marzo 2026</strong> (prima volta; Sensor Tower, dati fine maggio: 46,4%, davanti a Gemini 27,7% e Claude 10,3%). Sul web mondiale ChatGPT è sceso dal 76,5% (feb 2025) al 53,9% (mag 2026, Similarweb/Momentic) a vantaggio di Gemini (5,6% → 27,9%) e Claude (1,4% → 9,2%). Completano il quadro: run rate di Anthropic a <strong>$47B</strong> (annuncio Series H, 29 maggio 2026; OpenAI ~$25B ARR). <em>(Attenzione: StatCounter e i tool di misurazione web danno numeri molto diversi — metodologie diverse, referral vs visite vs app; non vanno fusi.)</em> <strong>Implicazione GEO:</strong> non si ottimizza per un solo motore — ChatGPT, Gemini e Claude sono ormai il set base che copre ~84% dell'audience app, e ogni engine va monitorato separatamente (vedi sezione Misurazione).</p>
    </div>
  </div>
</section>
  ...
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ul>
        ...
        <li><strong>20 luglio 2026:</strong> la Commissione pubblica le linee guida volontarie per il Code of Practice sull'etichettatura AI.</li>
        <li><strong>2 agosto 2026 (ora attivo):</strong> piena applicabilità, inclusi gli <strong>obblighi di trasparenza dell'art. 50</strong>: marking machine-readable degli output generativi, etichettatura di deepfake e testi AI su temi di interesse pubblico, informazione agli utenti dei chatbot. Sanzioni fino a <strong>€15M o 3% del fatturato mondiale</strong>. Contenuti pubblicati prima del 2 agosto 2026 non vanno etichettati retroattivamente; periodo transitorio fino al <strong>2 dicembre 2026</strong>. Eccezione rilevante: la marcatura non è richiesta per contenuti AI sottoposti a <strong>revisione editoriale umana con responsabilità di persona identificabile</strong>.</li>
      </ul>
      <p>Per un freelance: gli obblighi diretti ricadono sui <em>fornitori</em> di modelli, non su chi pubblica siti. Ma dal 2 agosto 2026 <strong>chi pubblica contenuti AI (testo, immagini, video) per conto di clienti su temi di interesse pubblico deve etichettarli</strong>, salvo revisione editoriale umana documentata (clausole nei contratti, responsabilità editoriale registrata nel CMS): la conformità all'art. 50 entra nella due diligence professionale, insieme alla gestione di opt-out/licensing.</p>
    </div>
  </div>
</section>
...
<section id="s5">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ol>
        <li><strong>Fase 1 — Fondamenta tecniche (immediato):</strong> verifica l'indicizzazione su Bing Webmaster Tools (prerequisito per ChatGPT) e usa IndexNow; audita il robots.txt consentendo i bot di retrieval (OAI-SearchBot, ChatGPT-User, Claude-SearchBot, Claude-User, PerplexityBot, Perplexity-User) anche bloccando il training — e per i siti dietro Cloudflare decidere consapevolmente, <strong>entro il 15 settembre 2026</strong>, se accettare/bloccare/monetizzare i crawler AI "mixed-use" ora bloccati di default; rendering server-side del contenuto chiave e HTML semantico pulito; <strong>attiva e monitora i nuovi report "Generative AI" di Search Console</strong> (globali dal 31 agosto 2026) per una baseline di impression su AI Overviews/AI Mode/Discover — solo impression, non click; <strong>rimuovi le dipendenze dai rich results deprecati</strong> (FAQ dal 7 maggio 2026; il markup FAQPage resta valido ma non produce più rich result, e l'API Search Console per i dati FAQ è stata rimossa ad agosto 2026); per i clienti UE che pubblicano contenuti AI, <strong>metti in conformità con l'art. 50 AI Act</strong> (etichettatura, responsabilità editoriale documentata, clausole nei contratti).</li>
        ...
        <li><strong>Fase 3 — Autorità e misurazione (3-6 mesi):</strong> costruisci menzioni di brand e citazioni di terze parti (G2/Trustpilot, PR digitale, YouTube, Reddit; Wikipedia per il grounding delle entità dove rilevante — la correlazione più forte con le citazioni AI resta il volume di ricerca del brand, più dei backlink); implementa un tool di tracking AI (Otterly entry ~$29/mese, Peec AI per il multilingua europeo, Semrush AI Visibility Toolkit da $99, Profound enterprise) e monitora trend con run ripetute, non snapshot; <strong>traccia il traffico da AI come canale separato in GA4</strong> e introduci KPI di AI visibility (share of voice, citation rate) — pratica ancora rara: solo il 16% delle Fortune 500 e il 22% dei marketer la tracciano (AirOps; Averi, mar 2026).</li>
      </ol>
      ...
      <ul>
        ...
        <li>Se Search Console aggiungerà i <strong>click</strong> (oggi solo impression) ai report "Generative AI", la misurazione GEO cambia in profondità.</li>
        <li>Se <strong>AI Mode diventerà default in Italia</strong> o il blocco Cloudflare/RSL genererà referral significativi da pay-per-use, rivedi policy crawler e priorità.</li>
        <li>Se un tool AI supererà stabilmente ChatGPT come motore di citazione, ripriorita i test per-engine.</li>
...
<section id="s6">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <p>Una proposta di Jeremy Howard (settembre 2024), un file Markdown nella root per aiutare gli LLM a usare un sito in inferenza; nasce per la <em>documentazione tecnica destinata a dev tool</em>, non come leva SEO. Le prove contro: Google <em>Search</em> dichiara di non usarlo; la guida del 15 maggio 2026 dice che nuovi file machine-readable, AI text file, markup o Markdown <em>"won't harm (nor help)"</em> la visibilità; Otterly rileva 84 richieste su 62.100 in 90 giorni (0,1%); Ahrefs (studio 15 giugno 2026, ~38.000 file validi su 137.210 domini) rileva che il <strong>97% dei file non riceve alcuna richiesta</strong> e che solo il 19,5% delle fetch arriva da tool AI nominati; SE Ranking non trova correlazione con le citazioni e togliere la variabile migliora il modello. Il fatto nuovo non va frainteso: <strong>Lighthouse 13.3.0</strong> ha aggiunto <code>llms.txt</code> alla categoria sperimentale <em>Agentic Browsing</em>, ma come check opzionale di <strong>agentic readiness</strong>, non come segnale di ranking o citazione Search. Lighthouse è diagnostica per sviluppatori, non motore di ricerca; l'audit segna il 404 come <em>Not Applicable</em> e non assegna nemmeno un punteggio 0-100. <strong>Verdetto:</strong> leva di citazione AI <strong>non provata, con evidenza prevalentemente contraria</strong>. Se il CMS lo genera a basso costo può restare infrastruttura orientata al futuro, ma va versionato e protetto: chi lo vende come fattore GEO oggi sta gonfiando una scommessa.</p>
      ...
      <p>Il claim hype: "senza schema.org non vieni citato dall'AI". Google (maggio 2026) lo dichiara <strong>non richiesto</strong> per generare risposte AI ("nessuno schema speciale per AI Overviews o AI Mode") e dice di usarlo quando corrisponde al contenuto visibile, per la comprensione delle entità — non come leva diretta di ranking; Pedro Dias e altri hanno mostrato che lo schema non influenza le citazioni ChatGPT. Gli studi di correlazione esistono ma sono <strong>confusi da variabili terze</strong>: i siti con schema tendono a essere anche più curati e autorevoli — la correlazione non isola lo schema come causa. <strong>Contesto in rapida erosione dei rich result:</strong> Google ha deprecato i <strong>FAQ rich results dal 7 maggio 2026</strong> (dopo HowTo nel 2023 e sette tipi a giugno 2025); il markup FAQPage resta valido ma non produce più rich result (l'API Search Console per i dati FAQ è stata rimossa ad agosto 2026). <strong>Verdetto bilanciato:</strong> resta utile per i suoi scopi classici (rich result, parsing, disambiguazione di entità) e per la Search tradizionale, non come "trucco AI" — e non fondare decisioni o audit sui rich result FAQ.</p>
      ...
      <p>Altrettanto falsa: i dati Ahrefs/Semrush mostrano che il ranking organico tradizionale <strong>resta correlato</strong> (anche se non più condizione necessaria) con la citazione AI; gli AI Overviews girano <em>sopra</em> il sistema di ranking Search; i catastrofismi si sono ridimensionati nel 2026 — il CTR organico in presenza di AIO è <strong>risalito</strong> (Seer: da ~1,3% a ~2,4% tra dic 2025 e feb 2026) e il traffico da AI <strong>converte molto meglio</strong> (4,4x–23x, Adobe +42%): molti brand perdono click ma non fatturato, il gioco si sposta dai click alle citazioni senza chiudersi; la "visibilità parametrica" si costruisce con gli stessi segnali del SEO classico (autorità, copertura stampa, Wikipedia, backlink, menzioni). Dato che rafforza il punto: secondo Seer Interactive le citazioni potrebbero essere <strong>"post-hoc"</strong> — l'LLM deciderebbe prima quali brand raccomandare (dalla conoscenza parametrica) e poi cercherebbe fonti a supporto; se confermata, l'ottimizzazione delle citazioni da sola non compensa una brand authority debole. <em>(Ipotesi, non fatto acclarato.)</em> Google stessa intitola la sua posizione "AEO e GEO sono ancora SEO". <strong>La GEO è un'estensione del SEO, non un suo sostituto.</strong> Le fondamenta sono <em>più</em> importanti, non meno; ciò che cambia è il livello di competizione (chunk vs pagina), le superfici e le metriche.</p>
      <div class="tablewrap"><table>
        ...
        <tr><td>Menzioni brand &gt; backlink</td><td><span class="badge b-warn">Convergente</span></td><td>Media</td></tr>
        ...
        <tr><td>llms.txt come leva</td><td><span class="badge b-bad">Non provato per citazioni</span></td><td>Bassissima</td></tr>
        <tr><td>Servire pagine in Markdown</td><td><span class="badge b-warn">Marginale</span></td><td>Bassa</td></tr>
        <tr><td>Report "Generative AI" di Search Console come misurazione completa</td><td><span class="badge b-warn">Incompleto (solo impression)</span></td><td>Media (con caveat)</td></tr>
      ...
      <div class="note"><strong>Caveats di fondo.</strong> Distinguere fatti documentati da claim dei vendor: indici e numeri Pew/SparkToro/Ahrefs/Seer sono ben documentati; molti "fattori di citazione" precisi provengono da blog di vendor non verificabili. L'overlap tra citazioni AIO e top-10 varia tra studi (38% vs 76%, poi sceso a un range 12–54% a inizio 2026) anche per differenze metodologiche. Le previsioni sono previsioni (il 25% di Gartner è una stima del 2024; a settembre 2026 non si è verificata nella misura prevista). <strong>Non fondere metodologie:</strong> quote di mercato e conversion variano fortemente tra web-visit (Similarweb), app (Sensor Tower), referral (StatCounter) e clickstream; le "conversion 4,4x–23x" arrivano spesso da aziende che misurano il proprio traffico (bias di auto-selezione) con eventi di conversione non uniformi; i dati italiani di calo organico per settore sono stime di agenzie SEO, non statistiche ufficiali (l'unica fonte italiana robusta resta Audiweb-Audicom). La tesi Seer sulle citazioni "post-hoc" è un'ipotesi, non un fatto acclarato. I dettagli su <code>web.run</code>, fan-out e system prompt di ChatGPT derivano da analisi indipendenti (RESONEO/Meteoria, AirOps, Dejan), non da documentazione ufficiale completa, e cambiano da un modello all'altro. Le pipeline cambiano rapidamente: ogni dato ha una data di validità. Sul caso Lighthouse, la categoria "Agentic Browsing" è sperimentale e può cambiare; la documentazione Chrome non prova uso di <code>llms.txt</code> nelle citazioni Search.</div>
    </div>
  </div>
</section>
...
<footer>
  <div class="wrap">
    ...
    <div class="biblio">
      ...
      <h4>Zero-click, CTR e qualità del traffico (aggiornati 2026)</h4>
      <ul>
        <li>SparkToro, <em>Zero-Click 2026</em> (clickstream Similarweb, gen–apr 2026: 68,01%) — <a href="https://sparktoro.com/blog/">sparktoro.com</a>; Seer Interactive, <em>longitudinal AI Overviews CTR study</em> (53 brand, 5,47M query; rebound ~1,3% → ~2,4% dic 2025–feb 2026) — <a href="https://www.seerinteractive.com/insights/">seerinteractive.com</a></li>
        <li>Pew Research, <em>Google users are less likely to click on links when an AI summary appears</em> (lug 2025) — <a href="https://www.pewresearch.org/short-reads/2025/07/22/google-users-are-less-likely-to-click-on-links-when-an-ai-summary-appears-in-the-results/">pewresearch.org</a>; Semrush, <em>AI visitors convert 4,4x better</em> (9 giu 2025) — <a href="https://www.semrush.com/blog/ai-search-visitor-value/">semrush.com</a>; Ahrefs, <em>AI Search Traffic Converts 23x Better</em> (giu 2025) — <a href="https://ahrefs.com/blog/ai-search-traffic-converts-23x-better/">ahrefs.com</a></li>
        <li>Adobe Digital Insights, <em>AI referral conversion +42% vs non-AI</em> (mar 2026) — via Search Engine Land; Ahrefs, <em>AI Overviews top-10 overlap</em> (gen 2026: 38%; aggiornamento 2026: solo 12% degli URL citati in top 10)</li>
      </ul>
      <h4>Search Console, crawler AI e licensing (giu–set 2026)</h4>
      <ul>
        <li>Google Search Central, <em>Search Generative AI performance reports in Search Console</em> (3 giu 2026 UK; globali dal 31 ago 2026; solo impression, opt-out senza penalità) — <a href="https://developers.google.com/search/blog">developers.google.com</a></li>
        <li>Cloudflare, <em>Content Independence / default blocking of AI crawlers</em> (annuncio 1 lug 2026; attivo dal 15 set 2026) e <em>Pay Per Use</em> — <a href="https://blog.cloudflare.com/">blog.cloudflare.com</a>; RSL — Really Simple Licensing (lancio 10 set 2025; RSL Media / Human Consent Standard, mag-giu 2026) — <a href="https://reallysimplelicensing.com/">reallysimplelicensing.com</a>; IETF, <em>AI Preferences</em> — <a href="https://datatracker.ietf.org/doc/draft-ietf-aipref/">datatracker.ietf.org</a></li>
        <li>Sensor Tower, <em>State of AI 2026</em> (quote app: ChatGPT 46,4%, Gemini 27,7%, Claude 10,3%); Anthropic, <em>Series H announcement</em> (run rate $47B, 29 mag 2026) — <a href="https://www.anthropic.com/news">anthropic.com</a>; CNBC (28 mag 2026)</li>
      </ul>
      ...
      <ul>
        <li>Direttiva (UE) 2019/790 (CDSM), artt. 3-4; AI Act (Reg. UE 2024/1689), art. 50 (trasparenza), art. 53(1)(c), Considerando 106; Commissione Europea, <em>linee guida Code of Practice sull'etichettatura AI</em> (20 lug 2026; obblighi art. 50 in vigore dal 2 ago 2026, transitorio fino al 2 dic 2026) — <a href="https://digital-strategy.ec.europa.eu/">digital-strategy.ec.europa.eu</a>; EPRS, <em>AI and copyright</em> — <a href="https://www.europarl.europa.eu/RegData/etudes/ATAG/2025/769585/EPRS_ATA(2025)769585_EN.pdf">europarl.europa.eu</a></li>
    ...
    <div class="foot-meta">
      White paper a cura di Federico Calicchia · redatto con il supporto di GLM 5.3 Flash (Z.ai), a partire da una ricerca condotta con Claude Opus 5 (Anthropic). Ultimo aggiornamento: 11 settembre 2026.<br>
