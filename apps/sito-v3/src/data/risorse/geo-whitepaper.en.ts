...
<section id="s6">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <p>A proposal by Jeremy Howard (September 2024), a Markdown file in the root to help LLMs use a site at inference time; it was born for <em>technical documentation aimed at dev tools</em>, not as an SEO lever. The evidence against: Google (Mueller, Illyes) states it does not use it and compares it to the obsolete "keywords meta tag"; Otterly detects 84 requests out of 62,100 in 90 days (0.1%); Ahrefs (May 2026, ~38,000 valid files across 137,210 domains) finds that <strong>97% of the files receive no requests</strong>; SE Ranking (~300,000 domains) finds no correlation with citations; Search Engine Land: <em>"there is no data or evidence showing that llms.txt files boost AI inclusion."</em> The grain of truth: Wix (AI Search Lab, over 1,400 files, Nov 2025) estimates that indexed files rose from ~30-60,000 to ~120,000 (May 2026, a peak of ~200,000 in April) — but it is a <strong>self-interested, unverified estimate</strong> (the "125,000" figure in the subtitle does not match the "~120,000" in the body) and, in the same source's words, <em>"this will not make or break your GEO strategy."</em> <strong>Verdict:</strong> an AI-citation lever that is <strong>unproven, with mostly contrary evidence</strong>. A legitimate and narrow use case (documentation for agents/dev tools). Realistic priority: very low.</p>
