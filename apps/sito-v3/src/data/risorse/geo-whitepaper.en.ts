  ...
  <div class="wrap">
    ...
    <div class="hero-grid">
      ...
      <div class="hero-sub">
        ...
        <div class="byline">
          Curated by <a href="https://github.com/federicokalik">Federico Calicchia</a> · written with the support of GLM 5.3 Flash (Z.ai) under editorial direction, based on research conducted with Claude Opus 5 (Anthropic).
        </div>
        <div class="meta-row"><span>Last updated · 11 September 2026</span></div>
      </div>
    </div>
  </div>
</header>
...
<section id="intro">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <div class="note"><strong>Methodological note.</strong> This document was put together from research on primary and secondary sources (academic papers, official engine documentation, industry reports, independent reverse-engineering analyses). The research was conducted with Claude Opus 5 (Anthropic) and updated as of 7 September 2026; the document itself was written with GLM 5.3 Flash, under editorial direction. The sections explicitly distinguish documented facts from vendor claims and from analyses not officially confirmed. All sources are listed in the bibliography.</div>
    </div>
  </div>
</section>
...
<section id="tldr">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      <h2>Five points</h2>
      <ul class="keylist">
        <li><div>Zero-click is structural: in 2024, 58.5% of US Google searches ended without a click (SparkToro/Datos), rising to <strong>68.01%</strong> in the first four months of 2026. With an AI Overview, the organic CTR of the top page drops by <strong>47-61%</strong> depending on the study (Authoritas, Pew, Seer Interactive, Ahrefs) — but the decline has stalled: CTR with AIO has rebounded from ~1.3% (Dec 2025) to ~2.4% (Feb 2026), with a residual structural gap of ~37% (Seer, 53 brands, 5.47M queries).</div></li>
      ...
      <div class="note">
        <strong>September 2026 update (Jun → Sep).</strong> The material changes after the first version was closed (22 June 2026): (1) <strong>Search Console — "Generative AI" reports</strong> (UK from 3 June 2026, global from 31 August: impressions only, no clicks or prompts; opt-out with no penalty). (2) <strong>Cloudflare</strong> blocks "mixed-use" AI crawlers by default on ad-funded pages from <strong>15 September 2026</strong>; Pay Per Crawl → Pay Per Use. (3) <strong>EU AI Act</strong> — art. 50 transparency obligations in force from <strong>2 August 2026</strong> (guidance 20 July; transition until 2 December; fines up to €15M or 3%). (4) <strong>AI Mode in France</strong> from 22 July 2026, with commitments on publisher opt-out. (5) <strong>ChatGPT Atlas discontinued as a browser</strong> on 9 August; Perplexity Comet free and on Android from 19 August. (6) <strong>Turning-point data:</strong> CTR with AIO rebounding (Seer) and AI traffic converting far better (Semrush 4.4x; Ahrefs 23x; Adobe +42%). (7) <strong>Market:</strong> ChatGPT below 50% of the app share (Mar 2026; Gemini ~28%, Claude ~10%); Anthropic run rate $47B. (8) <strong>Licensing:</strong> RSL Media / Human Consent Standard; AI crawlers = 52% of bot traffic.
      </div>
      <div class="panel">
        <h4>Key Findings</h4>
        <ol>
          <li><strong>Search behaviour has changed structurally, not marginally.</strong> Zero-click went from ~50% (SparkToro 2019) to 68.01% (Jan–Apr 2026, US). Gartner forecast (Feb 2024) a 25% decline in traditional search volume by 2026 — a forecast, not a final figure: by mid-2026 it has not materialised to the expected extent.</li>
          <li><strong>Traditional organic ranking remains important but is no longer sufficient.</strong> Ahrefs (Jan 2026): only 38% of pages cited in AI Overviews are also in the organic top 10 (it was 76% in July 2025); the overlap then fell to a 12–54% range in early 2026 across studies.</li>
  ...
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ul>
        ...
        <li>3 Jun 2026: Search Console launches the "Search Generative AI" reports (impressions in AI Overviews, AI Mode and Discover) for a subset of UK sites, under a CMA/DMA mandate.</li>
        <li>20 Jul 2026: the European Commission publishes voluntary guidance for the Code of Practice on AI labelling (AI Act art. 50), applicable from 2 August 2026.</li>
        <li>22 Jul 2026: AI Mode and AI Overviews arrive in France, the last major EU market, with commitments on publisher opt-out and neighbouring rights.</li>
        <li>31 Aug 2026: the Search Console "Generative AI" reports go global (data from 18 May 2026, no historical backfill; impressions only; opt-out with no penalty).</li>
        <li>15 Sep 2026 (announced on 1 July): Cloudflare activates the default blocking of "mixed-use" AI crawlers on ad-funded pages (new customers, new sites, free-tier customers); Pay Per Crawl → Pay Per Use.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Seer Interactive (longitudinal study, data to Feb 2026; 53 brands, 5.47M queries):</strong> turning point — organic CTR in the presence of an AIO fell to a low of ~1.3% in December 2025 and then <strong>rebounded to ~2.4% in February 2026</strong> (~85% recovery, reversing an 18-month decline). A structural gap of ~37% remains versus queries without an AIO (2.4% vs 3.8%).</li>
        <li><strong>Quality of AI traffic (Mar 2026):</strong> Semrush — the average AI search visitor is worth <strong>4.4x</strong> the traditional organic visitor; Ahrefs — AI search = 0.5% of traffic but 12.1% of sign-ups (<strong>23x</strong>); Adobe Digital Insights — AI traffic converted <strong>+42%</strong> better than non-AI in March 2026 (a flip from −43% in July 2024). <em>(Caution: different "conversion" definitions and often self-selected samples.)</em></li>
        <li><strong>Gartner (Feb 2024):</strong> forecast of −25% in traditional search volume by 2026 (a forecast, not a final figure). As of September 2026 it has not materialised to the expected extent.</li>
...
<section id="s2">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ul>
        <li><strong>ChatGPT (OpenAI):</strong> retrieval via third-party scraping APIs (historically tied to Bing; Seer found 87% overlap with Bing's top results); query fan-out; source selection that weighs authority, structure and freshness. The <strong>ChatGPT Atlas browser was discontinued on 9 August 2026</strong>: the agentic functions now live in the ChatGPT app and a Chrome extension.</li>
        <li><strong>Google Gemini / AI Overviews / AI Mode:</strong> its own web index + Knowledge Graph + Shopping; query fan-out documented via API; selection that also draws from outside the top 10 (Ahrefs Jan 2026: only 38% of citations from the top 10). Official scale: <strong>2.5 billion monthly users</strong> for AI Overviews and <strong>1 billion for AI Mode</strong> (Google I/O, May 2026; queries more than doubling every quarter since launch, Liz Reid). AI Mode runs on Gemini 2.5/3.5 Flash.</li>
        <li><strong>Perplexity:</strong> RAG with its own crawler (PerplexityBot); strong sensitivity to freshness; typically 3-5 sources per answer; multi-level ML reranking. The agentic browser <strong>Comet</strong> is now free and cross-platform (Mac, Windows, iOS, Android — on Android since 19 August 2026).</li>
      ...
      <p>Scale: in mid-2025 the models powered ~1.5 billion monthly users in AI Overviews and ~400M in the Gemini app; at the end of 2025/early 2026 the official Alphabet numbers rise to <strong>2 billion</strong> users for AI Overviews and <strong>750 million</strong> MAU for the Gemini app (Q4 2025); at Google I/O (May 2026) Google reports <strong>2.5 billion</strong> monthly users for AI Overviews and <strong>1 billion for AI Mode</strong>, with queries more than doubling every quarter (Liz Reid). AI Mode uses a <em>"custom version of Gemini"</em> with fan-out, which decomposes the query into many parallel sub-queries — the reason why pages not in the top 10 get cited. <strong>GEO consequence:</strong> optimising for Gemini means covering the <strong>tree of sub-questions</strong> of a topic, not a single keyword.</p>
      ...
      <div class="tablewrap"><table>
        ...
        <tr><td>Transparency</td><td>Low (rev-eng)</td><td>Medium-high (API + Search Console reports, impressions only)</td><td>Low-medium</td><td>High (docs + report)</td><td>Medium (docs)</td></tr>
      </table></div>
    </div>
  </div>
</section>
  ...
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ul>
        ...
        <li><strong>Brand mentions:</strong> brand search volume is the strongest predictor of AI citations (correlation 0.334 per Previsible/5WPR; unlinked mentions 0.664), more than backlinks; presence on Wikidata/Wikipedia plus authoritative platforms can multiply citation probability ~2.8x.</li>
      </ul>
      ...
      <p><strong>Correlation with traditional ranking (conflicting data):</strong> in July 2025 Ahrefs found 76% overlap between AIO citations and the top 10, in January 2026 only 38% (partly due to better detection, partly to fan-out); in early 2026 the overlap fell to a 12–54% range across studies (only 12% of URLs cited by LLMs are in the top 10, per Ahrefs). Semrush: ~90% of ChatGPT citations from URLs outside Google's top 20. Ranking helps but is not a necessary condition.</p>
...
<section id="s4">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <h4>Adoption</h4>
      <p><strong>Eurostat 2025:</strong> use of GenAI tools in Italy at <strong>20%</strong> (19.9% per the official survey), below the EU average of 32.7% and far from Norway (56%) and Denmark (48%); it reflects the European north-south gap. ChatGPT in Europe: average monthly active users from 11.2 to 41.3 million by March 2025 (~+270%). Italy was the <strong>first country in the world</strong> to temporarily block ChatGPT (March 2023). <strong>Adoption measured as audience (not to be mixed with Eurostat):</strong> ~15 million Italians (35% of the online population 18-74) were using AI apps in December 2025, more than double 2024 (Audicom-Audiweb); ChatGPT 10.1 million unique users (23.6% of the 18-74 population); ChatGPT generates over 84% of AI referral traffic in Italy (We Are Social/Meltwater, <em>Digital 2026: Italy</em>). The Eurostat (~20%) vs Audiweb (~35%) divergence reflects different definitions: present both with their source, do not mix them.</p>
      <h4>AI Overviews timing in Europe</h4>
      <p>They arrived in Italy on <strong>26 March 2025</strong> (alongside Austria, Belgium, Germany, Ireland, Poland, Portugal, Spain, Switzerland), ~10 months after the US, in Italian and on Gemini 2.0. They trigger for long-tail informational queries. AI Mode in Italian was not fully launched as of mid-2026. <strong>The French precedent (July 2026):</strong> France was initially <strong>excluded</strong> from the AI Mode and AI Overviews rollout for regulatory reasons concerning neighbouring rights; from <strong>22 July 2026</strong> both features are active there too, with Google commitments on publisher opt-out and compensation — the reference case for the FIEG-AGCOM/EU debate.</p>
      ...
      <h4>Updated Western market shares (September 2026)</h4>
      <p>The most relevant recent figure: <strong>ChatGPT fell below 50% of the app share in March 2026</strong> (a first; Sensor Tower, data to late May: 46.4%, ahead of Gemini 27.7% and Claude 10.3%). On the global web, ChatGPT fell from 76.5% (Feb 2025) to 53.9% (May 2026, Similarweb/Momentic) to the benefit of Gemini (5.6% → 27.9%) and Claude (1.4% → 9.2%). Completing the picture: Anthropic's run rate at <strong>$47B</strong> (Series H announcement, 29 May 2026; OpenAI ~$25B ARR). <em>(Caution: StatCounter and web-measurement tools report very different figures — different methodologies, referral vs visits vs app; they must not be mixed.)</em> <strong>GEO implication:</strong> you do not optimise for a single engine — ChatGPT, Gemini and Claude are now the base set covering ~84% of the app audience, and each engine must be monitored separately (see the Measurement section).</p>
    </div>
  </div>
</section>
  ...
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ul>
        ...
        <li><strong>20 July 2026:</strong> the Commission publishes voluntary guidance for the Code of Practice on AI labelling.</li>
        <li><strong>2 August 2026 (now in force):</strong> full applicability, including the <strong>art. 50 transparency obligations</strong>: machine-readable marking of generative outputs, labelling of deepfakes and AI texts on matters of public interest, user information for chatbots. Fines up to <strong>€15M or 3% of global turnover</strong>. Content published before 2 August 2026 is not retroactively labelled; the transition period runs until <strong>2 December 2026</strong>. A relevant exemption: marking is not required for AI content subject to <strong>human editorial review with an identifiable person's responsibility</strong>.</li>
      </ul>
      <p>For a freelancer: the direct obligations fall on model <em>providers</em>, not on those who publish sites. But as of 2 August 2026 <strong>anyone publishing AI content (text, images, video) for clients on matters of public interest must label it</strong>, unless human editorial review is documented (contractual clauses, editorial responsibility recorded in the CMS): art. 50 compliance enters professional due diligence, together with the handling of opt-out/licensing.</p>
    </div>
  </div>
</section>
...
<section id="s5">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <ol>
        <li><strong>Phase 1 — Technical foundations (immediate):</strong> verify indexing on Bing Webmaster Tools (a prerequisite for ChatGPT) and use IndexNow; audit robots.txt allowing the retrieval bots (OAI-SearchBot, ChatGPT-User, Claude-SearchBot, Claude-User, PerplexityBot, Perplexity-User) even while blocking training — and for sites behind Cloudflare, consciously decide <strong>before 15 September 2026</strong> whether to accept/block/monetise the "mixed-use" AI crawlers now blocked by default; server-side rendering of the key content and clean semantic HTML; <strong>activate and monitor the new Search Console "Generative AI" reports</strong> (global from 31 August 2026) for an impressions baseline on AI Overviews/AI Mode/Discover — impressions only, no clicks; <strong>remove dependencies on deprecated rich results</strong> (FAQ since 7 May 2026; the FAQPage markup remains valid but no longer produces rich results, and the Search Console FAQ API was removed in August 2026); for EU clients publishing AI content, <strong>bring them into compliance with AI Act art. 50</strong> (labelling, documented editorial responsibility, contractual clauses).</li>
        ...
        <li><strong>Phase 3 — Authority and measurement (3-6 months):</strong> build brand mentions and third-party citations (G2/Trustpilot, digital PR, YouTube, Reddit; Wikipedia for entity grounding where relevant — the strongest correlation with AI citations remains brand search volume, more than backlinks); implement an AI tracking tool (Otterly entry ~$29/month, Peec AI for European multilingual, Semrush AI Visibility Toolkit from $99, Profound enterprise) and monitor trends with repeated runs, not snapshots; <strong>track AI traffic as a separate channel in GA4</strong> and introduce AI-visibility KPIs (share of voice, citation rate) — still a rare practice: only 16% of Fortune 500 companies and 22% of marketers do it (AirOps; Averi, Mar 2026).</li>
      </ol>
      ...
      <ul>
        ...
        <li>If Search Console adds <strong>clicks</strong> (today impressions only) to the "Generative AI" reports, GEO measurement changes in depth.</li>
        <li>If <strong>AI Mode becomes the default in Italy</strong>, or the Cloudflare block/RSL generates significant pay-per-use referrals, revisit crawler policy and priorities.</li>
        <li>If an AI engine overtakes ChatGPT consistently as a citation source, re-prioritise per-engine testing.</li>
...
<section id="s6">
  <div class="sec-grid">
    ...
    <div class="sec-body">
      ...
      <p>The hype claim: "without schema.org you don't get cited by AI". Google (May 2026) declares it <strong>not required</strong> to generate AI answers ("no special schema for AI Overviews or AI Mode") and says to use it where it matches visible content, for entity comprehension — not as a direct ranking lever; Pedro Dias and others have shown that schema does not influence ChatGPT citations. Correlation studies exist but are <strong>confounded by third variables</strong>: sites with schema also tend to be better maintained and more authoritative — the correlation does not isolate schema as the cause. <strong>A fast-eroding context for rich results:</strong> Google deprecated the <strong>FAQ rich results on 7 May 2026</strong> (after HowTo in 2023 and seven types in June 2025); the FAQPage markup remains valid but no longer produces rich results (the Search Console FAQ API was removed in August 2026). <strong>Balanced verdict:</strong> it remains useful for its classic purposes (rich results, parsing, entity disambiguation) and for traditional Search, not as an "AI trick" — and don't build decisions or audits on FAQ rich results.</p>
      ...
      <p>Equally false: the Ahrefs/Semrush data show that traditional organic ranking <strong>remains correlated</strong> (even if no longer a necessary condition) with AI citation; AI Overviews run <em>on top of</em> the Search ranking system; the doomsaying has scaled down in 2026 — organic CTR in the presence of an AIO has <strong>rebounded</strong> (Seer: from ~1.3% to ~2.4% between Dec 2025 and Feb 2026) and AI traffic <strong>converts far better</strong> (4.4x–23x, Adobe +42%): many brands lose clicks but not revenue, the game shifts from clicks to citations without closing; "parametric visibility" is built with the same signals as classic SEO (authority, press coverage, Wikipedia, backlinks, mentions). A data point that strengthens this: per Seer Interactive, citations may be <strong>"post-hoc"</strong> — the LLM would first decide which brands to recommend (from parametric knowledge) and then search for supporting sources; if confirmed, optimising citations alone does not compensate for weak brand authority. <em>(A hypothesis, not an established fact.)</em> Google itself titles its position "AEO and GEO are still SEO". <strong>GEO is an extension of SEO, not a replacement.</strong> The foundations are <em>more</em> important, not less; what changes is the level of competition (chunk vs page), the surfaces and the metrics.</p>
      <div class="tablewrap"><table>
        ...
        <tr><td>Brand mentions &gt; backlinks</td><td><span class="badge b-warn">Converging</span></td><td>Medium</td></tr>
        ...
        <tr><td>Search Console "Generative AI" reports as complete measurement</td><td><span class="badge b-warn">Incomplete (impressions only)</span></td><td>Medium (with caveats)</td></tr>
...
<footer>
  <div class="wrap">
    ...
    <div class="biblio">
      ...
      <h4>Zero-click, CTR and traffic quality (updated 2026)</h4>
      <ul>
        <li>SparkToro, <em>Zero-Click 2026</em> (Similarweb clickstream, Jan–Apr 2026: 68.01%) — <a href="https://sparktoro.com/blog/">sparktoro.com</a>; Seer Interactive, <em>longitudinal AI Overviews CTR study</em> (53 brands, 5.47M queries; rebound ~1.3% → ~2.4% Dec 2025–Feb 2026) — <a href="https://www.seerinteractive.com/insights/">seerinteractive.com</a></li>
        <li>Pew Research, <em>Google users are less likely to click on links when an AI summary appears</em> (Jul 2025) — <a href="https://www.pewresearch.org/short-reads/2025/07/22/google-users-are-less-likely-to-click-on-links-when-an-ai-summary-appears-in-the-results/">pewresearch.org</a>; Semrush, <em>AI visitors convert 4,4x better</em> (9 Jun 2025) — <a href="https://www.semrush.com/blog/ai-search-visitor-value/">semrush.com</a>; Ahrefs, <em>AI Search Traffic Converts 23x Better</em> (Jun 2025) — <a href="https://ahrefs.com/blog/ai-search-traffic-converts-23x-better/">ahrefs.com</a></li>
        <li>Adobe Digital Insights, <em>AI referral conversion +42% vs non-AI</em> (Mar 2026) — via Search Engine Land; Ahrefs, <em>AI Overviews top-10 overlap</em> (Jan 2026: 38%; 2026 update: only 12% of cited URLs in the top 10)</li>
      </ul>
      <h4>Search Console, AI crawlers and licensing (Jun–Sep 2026)</h4>
      <ul>
        <li>Google Search Central, <em>Search Generative AI performance reports in Search Console</em> (3 Jun 2026 UK; global from 31 Aug 2026; impressions only, opt-out with no penalty) — <a href="https://developers.google.com/search/blog">developers.google.com</a></li>
        <li>Cloudflare, <em>Content Independence / default blocking of AI crawlers</em> (announced 1 Jul 2026; active from 15 Sep 2026) and <em>Pay Per Use</em> — <a href="https://blog.cloudflare.com/">blog.cloudflare.com</a>; RSL — Really Simple Licensing (launched 10 Sep 2025; RSL Media / Human Consent Standard, May–Jun 2026) — <a href="https://reallysimplelicensing.com/">reallysimplelicensing.com</a>; IETF, <em>AI Preferences</em> — <a href="https://datatracker.ietf.org/doc/draft-ietf-aipref/">datatracker.ietf.org</a></li>
        <li>Sensor Tower, <em>State of AI 2026</em> (app shares: ChatGPT 46.4%, Gemini 27.7%, Claude 10.3%); Anthropic, <em>Series H announcement</em> ($47B run rate, 29 May 2026) — <a href="https://www.anthropic.com/news">anthropic.com</a>; CNBC (28 May 2026)</li>
      </ul>
      ...
      <ul>
        <li>Directive (EU) 2019/790 (CDSM), arts. 3-4; AI Act (Reg. EU 2024/1689), art. 50 (transparency), art. 53(1)(c), Recital 106; European Commission, <em>Code of Practice guidance on AI labelling</em> (20 Jul 2026; art. 50 obligations in force from 2 Aug 2026, transition until 2 Dec 2026) — <a href="https://digital-strategy.ec.europa.eu/">digital-strategy.ec.europa.eu</a>; EPRS, <em>AI and copyright</em> — <a href="https://www.europarl.europa.eu/RegData/etudes/ATAG/2025/769585/EPRS_ATA(2025)769585_EN.pdf">europarl.europa.eu</a></li>
    ...
    <div class="foot-meta">
      White paper curated by Federico Calicchia · written with the support of GLM 5.3 Flash (Z.ai), based on research conducted with Claude Opus 5 (Anthropic). Last updated: 11 September 2026.<br>
