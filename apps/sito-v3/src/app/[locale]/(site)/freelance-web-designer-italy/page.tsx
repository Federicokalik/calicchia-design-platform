...
export const metadata: Metadata = {
  ...
  twitter: buildTwitterCard('Freelance Web Designer & Developer based in Italy', "Italy-based, working in English. EU+UK+US clients. One contact, no agency middlemen, EU timezone.", 'en'),
};
