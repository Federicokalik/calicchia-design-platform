...
const T: Record<Locale, Strings> = {
  it: {
    ...
    teaserBody: 'Lascia la tua email per sbloccare il report completo: tutti i criteri, i dettagli e il piano di azioni su misura.',
    ...
    ctaDiyBody: 'Tutto ciò che serve è nel white paper: ogni criterio qui sopra rimanda alla sezione che spiega come intervenire.',
  ...
  en: {
    ...
    teaserBody: 'Leave your email to unlock the full report: all criteria, details and a tailored action plan.',
    ...
    ctaDiyBody: 'Everything you need is in the white paper: each criterion above links to the section explaining how to act.',
